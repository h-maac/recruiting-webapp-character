import type {Attribute, Attributes, Class} from "./types";
...
export const SkillModifierMap: Record<string, Attribute> = SKILL_LIST.reduce(
    (object, current) => ({...object, [current.name]: current.attributeModifier}), {});